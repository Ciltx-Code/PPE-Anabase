...
Class Controleur_congressiste{
    ...
    public function todo_ajouter(){
        ...
        if($continuer){
            $this->modele->addCongressiste($this->post["nomCongressisteAjout"],$this->post["prenomCongressisteAjout"],$this->post["adrcongressisteAjout"],$this->post["telcongressisteAjout"],$this->post["emailCongressiste"] ,$this->post["dateAjout"],$this->post["hotelAjout"] ,$this->post["organismeAjout"],$this->post["emailCongressiste"]);
